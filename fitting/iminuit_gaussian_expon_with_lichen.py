...
params_dict = {}
params_dict['mu'] = {'fix':False,'start_val':1.0,'limits':(0,3.0),'error':0.1}
params_dict['sigma'] = {'fix':False,'start_val':1.0,'limits':(0.01,3.0),'error':0.1}
params_dict['mylambda'] = {'fix':False,'start_val':1.0,'limits':(0,10.0),'error':0.1}
params_dict['fraction'] = {'fix':False,'start_val':0.5,'limits':(0,3.14),'error':0.1}


params_names,kwd = fitutils.dict2kwd(params_dict)
f = fitutils.Minuit_FCN([total],params_dict,negative_log_likelihood)
m = Minuit(f,**kwd)
